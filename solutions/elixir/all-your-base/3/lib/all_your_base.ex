defmodule AllYourBase do
  ...
  @spec convert_to_decimal(list,integer) :: integer
   def convert_to_decimal(digits,input_base) do 
    ...
    {a,_b}= Enum.reduce(digits,{0,0} , fn x, {ans,p} ->
          IO.puts(ans)
   ...
   @doc """
    this function is used to convert a number from one decimal to 
    another decimal
   """
   @spec convert_to(integer , integer) :: list
   def convert_to(0,_output_base) , do: []
